...
from .template_models import TemplateInfo, TemplateCombination
...
class TemplateCombinationEngine:
    ...
    def create_template_combination(self, main_template: TemplateInfo, 
                                  integrations: List[TemplateInfo],
                                  platform: str) -> TemplateCombination:
    ...
    def _has_compatible_features(self, template1: TemplateInfo, template2: TemplateInfo) -> bool:
        ...
        for theme in common_themes:
            if (any(theme in f for f in template1_features) and 
                any(theme in f for f in template2_features)):
                return True
        
        return False
    
    def _are_templates_complementary(self, template1: TemplateInfo, template2: TemplateInfo) -> bool:
    ...
    def _estimate_total_time(self, main_template: TemplateInfo, integrations: List[TemplateInfo]) -> str:
