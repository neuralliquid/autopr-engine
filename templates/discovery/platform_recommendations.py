...
from .template_models import TemplateInfo, PlatformRequirements, PlatformRecommendation
...
class PlatformRecommendationEngine:
    ...
    def _score_platform(self, platform: str, requirements: PlatformRequirements) -> Tuple[float, List[str]]:
        ...
        if requirements.project_type:
            project_score = self._score_project_type(platform, requirements.project_type, platform_templates)
        ...
        if requirements.technical_expertise:
            expertise_score = self._score_technical_expertise(platform, requirements.technical_expertise)
        ...
        if requirements.features:
            feature_score = self._score_features(platform, requirements.features, platform_templates)
    ...
    def _score_project_type(self, platform: str, project_type: str, templates: List[TemplateInfo]) -> float:
    ...
    def _score_features(self, platform: str, required_features: List[str], templates: List[TemplateInfo]) -> float:
