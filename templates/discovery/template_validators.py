...
class StructureValidator:
    ...
    @staticmethod
    def check_field_types(data: Dict[str, Any], file_path: Path, rule: ValidationRule) -> List[ValidationIssue]:
    ...
    @staticmethod
    def check_version_field(data: Dict[str, Any], file_path: Path, rule: ValidationRule) -> List[ValidationIssue]:
...
class VariablesValidator:
    ...
    def check_required_variables(data: Dict[str, Any], file_path: Path, rule: ValidationRule) -> List[ValidationIssue]:
        ...
        for var_name, var_config in variables.items():
            ...
            if ('required' not in var_config and 
                var_config.get('type') in ['string', 'number'] and
                'default' not in var_config):
                issues.append(ValidationIssue(
                    ValidationSeverity.WARNING,
                    "variables",
...
class DocumentationValidator:
    ...
    @staticmethod
    def check_setup_instructions(data: Dict[str, Any], file_path: Path, rule: ValidationRule) -> List[ValidationIssue]:
        """Check for setup instructions."""
        issues = []
        
        has_setup = (
            'setup_instructions' in data or
            'installation' in data or
            'getting_started' in data or
            ('documentation' in data and 
             isinstance(data['documentation'], dict) and
             any(key in data['documentation'] for key in ['setup', 'installation', 'getting_started']))
        )
    ...
    @staticmethod
    def check_best_practices(data: Dict[str, Any], file_path: Path, rule: ValidationRule) -> List[ValidationIssue]:
        """Check for best practices documentation."""
        issues = []
        
        has_best_practices = (
            'best_practices' in data or
            ('documentation' in data and 
             isinstance(data['documentation'], dict) and
             'best_practices' in data['documentation'])
        )
    ...
    @staticmethod
    def check_troubleshooting(data: Dict[str, Any], file_path: Path, rule: ValidationRule) -> List[ValidationIssue]:
        """Check for troubleshooting documentation."""
        issues = []
        
        has_troubleshooting = (
            'troubleshooting' in data or
            'faq' in data or
            ('documentation' in data and 
             isinstance(data['documentation'], dict) and
             any(key in data['documentation'] for key in ['troubleshooting', 'faq', 'common_issues']))
        )
...
class ExamplesValidator:
    ...
    @staticmethod
    def check_example_presence(data: Dict[str, Any], file_path: Path, rule: ValidationRule) -> List[ValidationIssue]:
...
class SecurityValidator:
    ...
    @staticmethod
    def check_hardcoded_secrets(data: Dict[str, Any], file_path: Path, rule: ValidationRule) -> List[ValidationIssue]:
    ...
    @staticmethod
    def check_security_documentation(data: Dict[str, Any], file_path: Path, rule: ValidationRule) -> List[ValidationIssue]:
        """Check for security documentation."""
        issues = []
        
        has_security_docs = (
            'security' in data or
            'security_considerations' in data or
            ('documentation' in data and 
             isinstance(data['documentation'], dict) and
             any(key in data['documentation'] for key in ['security', 'security_considerations']))
        )
...
class PerformanceValidator:
    ...
    @staticmethod
    def check_performance_documentation(data: Dict[str, Any], file_path: Path, rule: ValidationRule) -> List[ValidationIssue]:
        """Check for performance documentation."""
        issues = []
        
        has_performance_docs = (
            'performance' in data or
            'performance_considerations' in data or
            ('documentation' in data and 
             isinstance(data['documentation'], dict) and
             any(key in data['documentation'] for key in ['performance', 'performance_considerations']))
        )
    ...
    @staticmethod
    def check_resource_optimization(data: Dict[str, Any], file_path: Path, rule: ValidationRule) -> List[ValidationIssue]:
...
class ValidatorRegistry:
    ...
    def run_validation(self, check_function: str, data: Dict[str, Any], file_path: Path, rule: ValidationRule) -> List[ValidationIssue]:
