...
def demo_hybrid_templates() -> None:
    ...
    for platform in platforms_to_test:
        ...
        tsconfig = generator.generate_typescript_config(
            platform,
            variables={"target": "ES2020"}
        )
        ...
        testing_files = generator.generate_testing_files(
            platform,
            variables={"coverage_threshold": 85}
        )
    ...
    print(f"Fallback Dockerfile: {len(fallback_dockerfile.split()) if fallback_dockerfile else 0} words")
