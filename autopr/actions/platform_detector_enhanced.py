...
class EnhancedPlatformDetectorOutputs(BaseModel):
    ...
    hybrid_workflow_analysis: Optional[Dict[str, Any]]
...
class EnhancedPlatformDetector:
    def __init__(self):
        ...
        self.ai_code_platforms = {
            'cursor': {
                'files': ['.cursor/', '.cursorrules', 'cursor.config.json', '.cursor-settings'],
                'dependencies': ['@cursor/ai', 'cursor-cli'],
                'commit_patterns': ['cursor', 'generated with cursor', 'cursor ai', 'cursor ide'],
                'editor_patterns': ['cursor-tab-', '.cursor-settings'],
                'content_patterns': ['cursor.sh', '# Generated by Cursor', 'cursor.com'],
                'git_patterns': ['Author: Cursor', 'Co-authored-by: Cursor']
            },
            'copilot_workspace': {
                'files': ['.github/copilot/', 'copilot-workspace.yml', '.copilot/'],
                'commit_patterns': ['copilot workspace', 'github copilot', '@github-copilot', 'copilot generated'],
                'content_patterns': ['copilot-generated', 'github.com/features/copilot', 'GitHub Copilot'],
                'dependencies': ['@github/copilot'],
                'git_patterns': ['Co-authored-by: GitHub Copilot']
            },
            'continue': {
                'files': ['.continue/', 'continue.json', '.continue.json', 'continue_config.py'],
                ...
                'content_patterns': ['continue.dev', '# Generated by Continue']
            },
            'windsurf': {
                'files': ['.windsurf/', 'windsurf.config.js', '.codeium/', 'windsurf.json'],
                'dependencies': ['codeium', '@codeium/windsurf'],
                'commit_patterns': ['windsurf', 'codeium', 'ai-generated', 'windsurf ide'],
                'content_patterns': ['codeium.com', 'windsurf ide', 'windsurf.dev']
            },
            'aider': {
                ...
                'content_patterns': ['aider-chat', 'aider.chat', '# aider']
            }
        }
        ...
        self.web_ai_platforms = {
            'v0_dev': {
                'files': ['v0.config.js', '.v0/', 'v0-components/', 'v0.json'],
                'dependencies': ['@v0/ui', 'v0-cli', '@radix-ui/react-*'],
                'commit_patterns': ['v0.dev', 'generated by v0', 'vercel v0', 'v0 component'],
                'content_patterns': ['v0.dev', 'shadcn/ui', 'vercel ai', 'generated with v0'],
                'folder_patterns': ['components/ui/', 'lib/utils']
            },
            'claude_artifacts': {
                'commit_patterns': ['claude artifact', 'anthropic claude', 'generated by claude', 'claude.ai'],
                'content_patterns': ['claude.ai', 'anthropic artifact', '// Claude generated', 'Created with Claude'],
                'files': ['.claude/', 'claude-artifact.json', 'claude.config.js']
            },
            'openai_canvas': {
                'commit_patterns': ['openai canvas', 'chatgpt canvas', 'generated in canvas', 'openai'],
                'content_patterns': ['openai.com', 'chatgpt generated', '// OpenAI Canvas', 'Created with ChatGPT'],
                'files': ['canvas-project.json', '.openai/', 'openai.config.js']
            }
        }
        ...
        self.mobile_platforms = {
            'flutterflow': {
                'files': ['flutterflow.json', '.flutterflow/', 'ff_project.yaml', 'flutterflow_config.json'],
                'dependencies': ['flutterflow_ui', 'ff_animations'],
                'commit_patterns': ['flutterflow', 'exported from flutterflow', 'ff export'],
                'folder_patterns': ['lib/flutter_flow/', 'assets/flutterflow/']
            },
            'draftbit': {
                'files': ['draftbit.config.js', '.draftbit/', 'draftbit.json'],
        ...
        self.backend_platforms = {
            'supabase_ai': {
                'files': ['supabase/', 'supabase.config.js', 'supabase.json'],
                'dependencies': ['@supabase/supabase-js', 'supabase'],
                'commit_patterns': ['supabase ai', 'supabase generated', 'supabase magic'],
                'content_patterns': ['supabase.com', 'supabase database', 'supabase client']
            },
            'neon_ai': {
                'files': ['neon.config.js', '.neon/', 'neon.json'],
                'dependencies': ['@neon/serverless', '@neondatabase/serverless'],
                'commit_patterns': ['neon ai', 'neon database', 'neon generated'],
        ...
        self.design_platforms = {
            'figma_to_code': {
                'files': ['figma-tokens.json', '.figma/', 'design-tokens/', 'figma.config.js'],
                'dependencies': ['@figma/code-connect', 'figma-api', 'figma-to-react'],
                'commit_patterns': ['figma import', 'design tokens', 'figma to code', 'figma export'],
                'content_patterns': ['figma.com', 'design system', 'figma-generated'],
                'folder_patterns': ['design-tokens/', 'figma-assets/']
            },
            'framer': {
                'files': ['framer.config.js', '.framer/', 'framer-motion/', 'framer.json'],
                'dependencies': ['framer-motion', '@framer/motion', 'framer'],
                'commit_patterns': ['framer', 'framer export', 'framer code'],
                'content_patterns': ['framer.com', 'framer motion', 'framer generated']
            }
        }
        ...
        self.ai_assistants = {
            'tabnine': {
                ...
                'content_patterns': ['tabnine', 'generated by tabnine', '// TabNine'],
                'commit_patterns': ['tabnine suggestion', 'ai completion', 'tabnine generated']
            },
            'codewhisperer': {
                'files': ['.aws/codewhisperer/', 'codewhisperer.json'],
                'commit_patterns': ['codewhisperer', 'aws ai', 'amazon codewhisperer'],
                'content_patterns': ['aws.amazon.com/codewhisperer', '// CodeWhisperer']
            }
        }
        ...
        self.infrastructure_platforms = {
            'pulumi_ai': {
                'files': ['Pulumi.yaml', 'Pulumi.*.yaml', '.pulumi/', 'Pulumi.dev.yaml', 'Pulumi.prod.yaml'],
                'dependencies': ['@pulumi/pulumi', 'pulumi'],
                'commit_patterns': ['pulumi ai', 'infrastructure as code', 'pulumi generated', 'iac generated'],
                'content_patterns': ['pulumi.com', 'infrastructure ai', '# Generated by Pulumi AI']
            },
            'terraform_ai': {
                'files': ['main.tf', 'terraform.tf', '.terraform/', '*.tf'],
                'commit_patterns': ['terraform ai', 'ai-generated terraform', 'hcl generated', 'terraform generated'],
                'content_patterns': ['terraform.io', '# Generated by AI', '# AI-generated Terraform']
            }
        }
    ...
    def detect_platforms(self, inputs: EnhancedPlatformDetectorInputs) -> EnhancedPlatformDetectorOutputs:
        """Enhanced platform detection with multi-platform support"""
        
        # Scan workspace and collect data
        file_structure = self._scan_workspace_enhanced(inputs.workspace_path)
        package_json = self._parse_package_json(inputs.package_json_content, inputs.workspace_path)
        git_history = self._analyze_git_history(inputs.workspace_path, inputs.git_log_depth)
        ...
        workflow_type, hybrid_analysis = self._analyze_workflow_type(all_scores, primary_platform, secondary_platforms)
        
        # Generate platform-specific configurations
        configs = self._generate_platform_configs(primary_platform, secondary_platforms, file_structure, package_json)
        
        # Generate recommendations and opportunities
        enhancements = self._generate_enhancement_recommendations(primary_platform, secondary_platforms, detailed_analysis)
    ...
    def _is_key_file(self, filename: str) -> bool:
        ...
        key_files = {
            # Config files
            '.replit', 'replit.nix', 'package.json', 'composer.json', 'requirements.txt',
            'Dockerfile', 'docker-compose.yml', '.env.example', '.env',
            
            # Platform-specific configs
            'cursor.config.json', '.cursorrules', 'continue.json', 'lovable.config.js',
            'bolt.config.json', 'same.config.js', 'emergent.sh', 'v0.config.js',
            'figma-tokens.json', 'framer.config.js', 'supabase.config.js',
            'Pulumi.yaml', 'main.tf', 'terraform.tf',
        ...
        return filename.lower() in {f.lower() for f in key_files} or \
               any(pattern in filename.lower() for pattern in ['.config', '.yml', '.yaml', '.json'])
    ...
    def _calculate_enhanced_platform_score(self, platform: str, signatures: Dict, 
                                         inputs: EnhancedPlatformDetectorInputs,
                                         file_structure: Dict, package_json: Optional[Dict],
                                         git_history: Dict) -> Tuple[float, Dict]:
        ...
        for file_pattern in signatures.get('files', []):
            matches = [f for f in file_structure.get('files', []) if self._file_pattern_match(file_pattern, f)]
            if matches:
                score += 0.4
        ...
        for pattern in signatures.get('commit_patterns', []):
            matching_commits = [msg for msg in git_history.get('commit_messages', []) 
        ...
        if 'git_patterns' in signatures:
            for pattern in signatures['git_patterns']:
                matching_authors = [author for author in git_history.get('authors', [])
        ...
        if package_json:
            ...
            for dep_pattern in signatures.get('dependencies', []):
                matching_deps = [dep for dep in all_deps.keys() 
        ...
        advanced_score = self._advanced_platform_detection(platform, file_structure, package_json, git_history)
    ...
    def _advanced_platform_detection(self, platform: str, file_structure: Dict, 
                                    package_json: Optional[Dict], git_history: Dict) -> float:
    ...
    def _detect_cursor_advanced(self, file_structure: Dict, package_json: Optional[Dict], git_history: Dict) -> float:
        ...
        for file_path, content in file_structure.get('file_contents', {}).items():
            if '.cursorrules' in file_path:
                if any(keyword in content.lower() for keyword in ['ai assistant', 'cursor', 'code generation']):
                    score += 0.2
    ...
    def _detect_v0_advanced(self, file_structure: Dict, package_json: Optional[Dict], git_history: Dict) -> float:
        ...
        if package_json:
            ...
            shadcn_count = sum(1 for dep in deps.keys() 
        ...
        ui_components = [f for f in file_structure.get('files', []) 
    ...
    def _detect_copilot_advanced(self, file_structure: Dict, package_json: Optional[Dict], git_history: Dict) -> float:
        """Advanced GitHub Copilot detection"""
        score = 0.0
        
        # Check for Copilot co-authorship in git history
        copilot_commits = len([author for author in git_history.get('authors', [])
    ...
    def _detect_supabase_advanced(self, file_structure: Dict, package_json: Optional[Dict], git_history: Dict) -> float:
        """Advanced Supabase AI detection"""
        score = 0.0
        
        # Check for Supabase configuration files
        supabase_files = [f for f in file_structure.get('files', []) 
    ...
    def _detect_figma_advanced(self, file_structure: Dict, package_json: Optional[Dict], git_history: Dict) -> float:
        """Advanced Figma to Code detection"""
        score = 0.0
        
        # Check for design tokens structure
        design_token_files = [f for f in file_structure.get('files', [])
    ...
    def _detect_replit_advanced(self, file_structure: Dict, package_json: Optional[Dict], git_history: Dict) -> float:
    ...
    def _analyze_workflow_type(self, all_scores: Dict[str, float], 
                              primary_platform: str, secondary_platforms: List[str]) -> Tuple[str, Optional[Dict]]:
    ...
    def _generate_platform_configs(self, primary_platform: str, secondary_platforms: List[str],
                                  file_structure: Dict, package_json: Optional[Dict]) -> Dict[str, Any]:
        """Generate platform-specific configurations"""
        ...
        for platform in all_platforms:
            ...
            if platform in self.core_platforms:
                config.update(self._generate_core_platform_config(platform, file_structure, package_json))
            elif platform in self.ai_code_platforms:
                config.update(self._generate_ai_platform_config(platform, file_structure, package_json))
            elif platform in self.web_ai_platforms:
                config.update(self._generate_web_platform_config(platform, file_structure, package_json))
            
            configs[platform] = config
        
        return configs

    def _generate_core_platform_config(self, platform: str, file_structure: Dict, package_json: Optional[Dict]) -> Dict:
        ...
        if platform == 'replit':
            ...
            base_config.update({
                'framework': 'react',
                'typescript_detected': self._detect_typescript(file_structure),
    ...
    def _generate_ai_platform_config(self, platform: str, file_structure: Dict, package_json: Optional[Dict]) -> Dict:
    ...
    def _generate_web_platform_config(self, platform: str, file_structure: Dict, package_json: Optional[Dict]) -> Dict:
    ...
    def _generate_enhancement_recommendations(self, primary_platform: str, secondary_platforms: List[str],
                                            detailed_analysis: Dict) -> List[str]:
    ...
    def _get_platform_recommendations(self, platform: str, secondary: bool = False) -> List[str]:
        ...
        return platform_recommendations.get(platform, [f"{prefix}Add platform-specific optimizations"])

    def _generate_migration_opportunities(self, all_scores: Dict[str, float], 
                                        primary_platform: str) -> List[str]:
        """Generate migration opportunities to other platforms"""
        
        opportunities = []
        
        # Sort platforms by score (excluding primary)
        other_platforms = {k: v for k, v in all_scores.items() if k != primary_platform and v > 0.1}
        ...
        for platform, score in sorted_others[:3]:  # Top 3 alternatives
            if score > 0.15:
                ...
                opportunities.append(f"Consider {platform}: {benefit} (compatibility: {compatibility})")
        
        return opportunities

    def _detect_runtime(self, file_structure: Dict) -> str:
    ...
    def _detect_typescript(self, file_structure: Dict) -> bool:
        """Detect TypeScript usage"""
        extensions = file_structure.get('file_extensions', {})
        return extensions.get('.ts', 0) > 0 or extensions.get('.tsx', 0) > 0
...
if __name__ == "__main__":
    ...
    sample_inputs = {
        ...
        "commit_messages": ["Initial commit from Cursor", "Added v0 components", "Deployed with Vercel"],
        "workspace_path": ".",
        "git_log_depth": 50
    }
