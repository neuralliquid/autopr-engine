...
class ActionRegistry:
    ...
    def register_action(self, action_class: Type[Action]) -> None:
        """
        ...
        temp_instance = action_class("temp", "temp")
    ...
    def get_action(self, action_name: str) -> Optional[Action]:
        ...
        # Create new instance
        try:
            action_class = self._actions[action_name]
            instance = action_class(action_name, f"Instance of {action_name}")
